...
class AIGUI(tk.Tk):
    def __init__(self):
        ...
        tk.Label(frame_info, text="• Model Name\n• Category (Text, Vision, Audio)\n• Short Description").grid(row=1, column=0, sticky="w", padx=20)

        tk.Label(frame_info, text="OOP Concepts Explanation:").grid(row=0, column=1, sticky="w", padx=5)
        tk.Label(frame_info, text="• Where Multiple Inheritance applied\n• Why Encapsulation was applied\n• How Polymorphism & Method Overriding shown\n• Where Multiple Decorators applied").grid(row=1, column=1, sticky="w", padx=20)

        # Notes Section
        notes_label = tk.Label(self, text="Notes: Extra notes, instructions, or references.")
